...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/data-structure/predecessor_problem.test.cpp\"\
    ...
    \    cin >> n >> q;\n    string t;\n    cin >> t;\n    FastSet fs(n);\n    for(int\
    \ i=0;i<n;i++)if(t[i]=='1')fs.insert(i);\n    while(q--){\n        int op,k;\n\
    \        cin >> op >> k;\n        if(op==0){\n            fs.insert(k);\n    \
    \    }else if(op==1){\n            fs.erase(k);\n        }else if(op==2){\n  \
    \          cout << fs.count(k) << \"\\n\";\n        }else if(op==3){\n       \
    \     int x=fs.next(k);\n            if(x==n)x=-1;\n            cout << x << \"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/data-structure/predecessor_problem.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/data-structure/predecessor_problem.test.cpp
- /verify/verify/yosupo/data-structure/predecessor_problem.test.cpp.html
