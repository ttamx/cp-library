...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/graph/assignment.cpp\"\n#define PROBLEM \"\
    https://judge.yosupo.jp/problem/assignment\"\n#line 2 \"template.hpp\"\n#include<bits/stdc++.h>\n\
    ...
    \ v=1;v<=n;v++)g[u][v]=Edge(u,v,T(0));\n}\n\n};\n#line 4 \"verify/yosupo/graph/assignment.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/graph/assignment.cpp
layout: document
redirect_from:
- /library/verify/yosupo/graph/assignment.cpp
- /library/verify/yosupo/graph/assignment.cpp.html
