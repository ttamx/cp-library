...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/graph/general_weighted_matching.test.cpp\"\
    ...
    \ 3 \"flow/general-weighted-matching.hpp\"\n\n/**\n * Description: General weighted\
    \ matching using blossom algorithm.\n * Time: O(|V|^3) \\text{(fast in practice)}\n\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/graph/general_weighted_matching.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/graph/general_weighted_matching.test.cpp
- /verify/verify/yosupo/graph/general_weighted_matching.test.cpp.html
